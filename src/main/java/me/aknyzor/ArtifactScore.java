...
public class ArtifactScore {
    ...
    public Map<StatType, Double> getDefaultWeights() {
        ...
        if (Main.characterComboBox.getSelectedItem() == Main.Character.ALBEDO) {
            defaultWeights.put(StatType.DEF_FLAT, 0.25d);
            defaultWeights.put(StatType.DEF_PERCENT, 0.5d);
            ...
            defaultWeights.put(StatType.HP_PERCENT, 0.5d);
            defaultWeights.put(StatType.HP_FLAT, 0.25d);
            defaultWeights.put(StatType.HEALING_BONUS, 1d);
        }else if (Main.characterComboBox.getSelectedItem() == Main.Character.BARBARA) {
            defaultWeights.put(StatType.ELEMENTAL_MASTERY, 0.5d);
            defaultWeights.put(StatType.HP_PERCENT, 0.5d);
            defaultWeights.put(StatType.HEALING_BONUS, 1d);
        }else if (Main.characterComboBox.getSelectedItem() == Main.Character.BEIDOU) {
            defaultWeights.put(StatType.ATK_PERCENT, 0.5d);
            defaultWeights.put(StatType.ELECTRO_BONUS, 1d);
            defaultWeights.put(StatType.CRIT_DMG, 1d);
            defaultWeights.put(StatType.CRIT_RATE, 1d);
            defaultWeights.put(StatType.ENERY_RECHARGE, 0.5d);
        }else if (Main.characterComboBox.getSelectedItem() == Main.Character.BENNETT) {
            defaultWeights.put(StatType.ATK_PERCENT, 0.5d);
            defaultWeights.put(StatType.PYRO_BONUS, 1d);
            defaultWeights.put(StatType.CRIT_DMG, 1d);
            defaultWeights.put(StatType.CRIT_RATE, 1d);
            ...
            defaultWeights.put(StatType.HP_PERCENT, 0.5d);
            defaultWeights.put(StatType.HEALING_BONUS, 1d);
        }else if (Main.characterComboBox.getSelectedItem() == Main.Character.CANDACE) {
            defaultWeights.put(StatType.ENERY_RECHARGE, 0.5d);
            defaultWeights.put(StatType.HP_PERCENT, 0.5d);
            defaultWeights.put(StatType.HYDRO_BONUS, 1d);
            defaultWeights.put(StatType.CRIT_RATE, 1d);
            ...
            defaultWeights.put(StatType.ELEMENTAL_MASTERY, 0.5d);
            defaultWeights.put(StatType.ATK_PERCENT, 0.5d);
        }else if (Main.characterComboBox.getSelectedItem() == Main.Character.CHARLOTTE) {
            defaultWeights.put(StatType.ENERY_RECHARGE, 0.5d);
            defaultWeights.put(StatType.ATK_PERCENT, 0.5d);
            defaultWeights.put(StatType.CRYO_BONUS, 1d);
            defaultWeights.put(StatType.CRIT_RATE, 1d);
            defaultWeights.put(StatType.CRIT_DMG, 1d);
        }else if (Main.characterComboBox.getSelectedItem() == Main.Character.CHEVREUSE) {
            defaultWeights.put(StatType.ENERY_RECHARGE, 0.5d);
            defaultWeights.put(StatType.HP_PERCENT, 0.5d);
            defaultWeights.put(StatType.ATK_PERCENT, 0.5d);
            defaultWeights.put(StatType.HEALING_BONUS, 1d);
            defaultWeights.put(StatType.PYRO_BONUS, 0.5d);
            defaultWeights.put(StatType.CRIT_RATE, 1d);
            defaultWeights.put(StatType.CRIT_DMG, 1d);
        }else if (Main.characterComboBox.getSelectedItem() == Main.Character.CHIORI) {
            defaultWeights.put(StatType.DEF_PERCENT, 0.5d);
            defaultWeights.put(StatType.ATK_PERCENT, 0.5d);
            defaultWeights.put(StatType.GEO_BONUS, 1d);
            defaultWeights.put(StatType.CRIT_DMG, 1d);
            defaultWeights.put(StatType.CRIT_RATE, 1d);
        }else if (Main.characterComboBox.getSelectedItem() == Main.Character.CHONGYUN) {
            defaultWeights.put(StatType.ATK_PERCENT, 0.5d);
            defaultWeights.put(StatType.ELEMENTAL_MASTERY, 0.5d);
            defaultWeights.put(StatType.ENERY_RECHARGE, 0.5d);
            defaultWeights.put(StatType.CRYO_BONUS, 1d);
            defaultWeights.put(StatType.CRIT_DMG, 1d);
            defaultWeights.put(StatType.CRIT_RATE, 1d);
        }else if (Main.characterComboBox.getSelectedItem() == Main.Character.COLLEI) {
            defaultWeights.put(StatType.ATK_PERCENT, 0.5d);
            defaultWeights.put(StatType.ELEMENTAL_MASTERY, 0.5d);
            defaultWeights.put(StatType.ENERY_RECHARGE, 0.5d);
            defaultWeights.put(StatType.DENDRO_BONUS, 1d);
            defaultWeights.put(StatType.CRIT_DMG, 1d);
            defaultWeights.put(StatType.CRIT_RATE, 1d);
        }else if (Main.characterComboBox.getSelectedItem() == Main.Character.CYNO) {
            defaultWeights.put(StatType.ATK_PERCENT, 0.5d);
            defaultWeights.put(StatType.ELEMENTAL_MASTERY, 0.5d);
            defaultWeights.put(StatType.ENERY_RECHARGE, 0.5d);
            defaultWeights.put(StatType.ELECTRO_BONUS, 1d);
